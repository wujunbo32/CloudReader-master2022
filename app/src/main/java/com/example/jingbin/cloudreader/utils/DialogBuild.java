...
//                            ToastUtil.showToastLong("退出成功");
    ...
    public static void showPrivate(Context context, View.OnClickListener clickListener) {
        ...
        SpannableString doubleClickTag = BaseTools.getDoubleClickTag(context, R.color.colorTheme,  // 设置颜色
                CommonUtils.getString(context, R.string.string_private), "《隐私政策》",
                "", new BaseTools.OnActionListener<Integer>() {
            @Override
